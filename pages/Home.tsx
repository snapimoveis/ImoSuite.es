      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
            Encuentre su próximo <span className="text-[var(--secondary)]">hogar perfecto</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-200 mb-10 max-w-2xl mx-auto">
            Descubra las mejores oportunidades en España con {tenant.nome}.
          </p>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-12">
          <div>
            ...
            <p className="text-gray-500 max-w-md">Las propiedades más exclusivas y demandadas de nuestra cartera.</p>
          </div>
      ...
      <section className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">¿Por qué elegir {tenant.nome}?</h2>
            <div className="w-20 h-1.5 bg-[var(--primary)] mx-auto rounded-full" />
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { title: 'Experiencia de Mercado', desc: 'Más de 15 años haciendo realidad sueños en España.' },
              { title: 'Tecnología de Vanguardia', desc: 'SaaS exclusivo para mayor rapidez y eficiencia.' },
              { title: 'Atención Personalizada', desc: 'Cada cliente es único y merece total atención.' }
            ].map((item, idx) => (
